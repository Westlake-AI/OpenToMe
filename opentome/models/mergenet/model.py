...
class LocalEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        for i, blk in enumerate(self.vit.blocks):
            x, size, n, metirc, _ = blk(x, self.vit._tome_info["size"], n=n)
...
class HybridToMeModel(nn.Module):
    ...
    def __init__(self, 
        ...
        self._apply_patches(self.dtem_feat_dim, self.dtem_window_size, self.dtem_t, 
                            self.total_merge_local, self.tome_window_size, self.tome_use_naive_local, self.total_merge_latent)
