...
from opentome.models.utils import maybe_autocast
from opentome.models import initialization as init
from opentome.models.modeling_rope_utils import ROPE_INIT_FUNCTIONS, dynamic_rope_update
...
class BltForCausalLM(BltPreTrainedModel, FLAGenerationMixin):
    config: BltConfig
