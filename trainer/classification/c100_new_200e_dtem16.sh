#!/bin/bash
# bash c100_new_200e_dtem16.sh 2>&1 | tee train_log_$(date +%Y%m%d_%H%M%S).txt
# mergenet_new (HybridToMe), 标准 200 epoch 训练, dtem_window_size=16
...
EXP_NAME=cifar100_mergenet_small_new_200e_dtem16_test
