...
NNODE=1 NGPU=4 LOG_RANK=0 bash train.sh \
  ...
  --job.dump_folder exp/transformer/batch1.seqlen65536.grad_acc12.warmup1024.update1.steps30720.4gpus.lr3e-4 \
  ...
  --training.context_len 24576 \
  --training.varlen \
  --training.gradient_accumulation_steps 12 \
