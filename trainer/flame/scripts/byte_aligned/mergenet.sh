...
NNODE=1 NGPU=4 LOG_RANK=0 bash train.sh \
  ...
  --job.dump_folder exp/mergenet/batch1.seqlen16384.grad_acc8.warmup1024.update1.steps30720.4gpus.lr3e-4 \
  --model.config configs/mergenet_340M.json \
