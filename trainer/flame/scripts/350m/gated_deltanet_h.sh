...
export BACKBONE=gated_deltanet_h_340M
echo $BACKBONE


NNODE=1 NGPU=8 LOG_RANK=0 bash train.sh \
  --job.config_file flame/models/fla.toml \
  --job.dump_folder exp/gated_deltanet_h_340M-10B/batch1.seqlen32768.grad_acc2.warmup1024.update1.steps30720.8gpus.lr4e-4 \
