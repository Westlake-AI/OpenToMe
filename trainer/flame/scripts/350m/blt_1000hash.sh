...
NNODE=1 NGPU=4 LOG_RANK=0 bash train.sh \
  ...
  --job.dump_folder exp/blt_380M_10B_1000hash/batch1.seqlen16384.grad_acc8.warmup1024.update1.steps30720.4gpus.lr3e-4 \
  --model.config configs/blt_transformer_1000hash.json \
