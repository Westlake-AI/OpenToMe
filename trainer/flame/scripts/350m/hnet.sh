...
# export BACKBONE=hnet
# export TOKENIZER_NAME=bytes
# echo $BACKBONE
# echo $TOKENIZER_NAME

# NNODE=1 NGPU=4 LOG_RANK=0 bash train.sh \
#   --job.config_file flame/models/fla.toml \
#   --job.dump_folder exp/hnet_340M_10B/batch1.seqlen16384.grad_acc8.warmup1024.update1.steps30720.4gpus.lr3e-4 \
#   --model.config configs/hnet_340M.json \
